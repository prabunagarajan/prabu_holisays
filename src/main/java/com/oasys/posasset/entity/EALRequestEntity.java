...
@Table(name = "eal_request")
public class EALRequestEntity  extends Trackablewastage{
	...
	@Column(name = "tot_roll")
	private Integer totRoll;
...
//	
	...
	private String puLicenseNo;
	 ...
	 @Column(name = "vendor_assigned_date")
	 public LocalDateTime vendorAssignedDate;
