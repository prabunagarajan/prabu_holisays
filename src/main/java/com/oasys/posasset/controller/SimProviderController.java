...
@RequestMapping("/simproviderdet")
public class SimProviderController {
	...
	public ResponseEntity<Object> adddticketPage(@Valid @RequestBody SIMProviderRequestDTO requestDTO)
			throws RecordNotFoundException, Exception {

		return new ResponseEntity<>(simproviderservice.addsimprovider(requestDTO),
	...
	public ResponseEntity<Object> getAllActive() {
		return new ResponseEntity<>(simproviderservice.getAllActive(), ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	
	@GetMapping("/getlist")
	@ApiOperation(value = "This api is to get all Ticketstatus list", notes = "Returns HTTP 200 if successful get the record")
	public ResponseEntity<Object> getAll() {
		return new ResponseEntity<>(simproviderservice.getAll(), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getById(@PathVariable("id") Long id) {
		return new ResponseEntity<>(simproviderservice.getById(id), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
