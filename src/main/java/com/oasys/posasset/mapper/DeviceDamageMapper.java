...
@Component
public class DeviceDamageMapper {
	...
	public DevicelostResponseDTO convertEntityToResponseDTO(DeviceDamageEntity tsEntity) {
		...
		devicelostResponseDTO.setApplicationNumber(tsEntity.getDeviceDamageapplnno());
		...
		devicelostResponseDTO.setLastsatusDevice(tsEntity.getDamagedeviceName());
