...
//		interceptors.add(new HeaderRequestInterceptor("Access-Control-Allow-Methods", "HEAD,OPTIONS,GET,POST,PUT,PATCH,DELETE"));
//		interceptors.add(new HeaderRequestInterceptor("Access-Control-Allow-Headers", "X-Requested-With,Origin,Content-Type, Accept, x-device-user-agent, Content-Type"));
//		interceptors.add(new HeaderRequestInterceptor("Access-Control-Allow-Credentials", "true"));
//		interceptors.add(new HeaderRequestInterceptor("X-Authorization","Bearer "+token));
//		
//		
//		return interceptors;
//	}
