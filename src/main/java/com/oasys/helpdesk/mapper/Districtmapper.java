...
public class Districtmapper {
	...
	public DistrictResponseDTO convertEntityToResponseDTO(DistrictEntity tsEntity) {
		DistrictResponseDTO ticketstatusResponseDTO = commonUtil.modalMap(tsEntity, DistrictResponseDTO.class);
