...
public class UsergroupMapper {
	...
	public UsergroupResponseDTO convertEntityToResponseDTO(UserGroupEntity tsEntity) {
		UsergroupResponseDTO ticketstatusResponseDTO = commonUtil.modalMap(tsEntity, UsergroupResponseDTO.class);
