...
import com.oasys.helpdesk.service.FieldAgentService;
...
@RestController
@Api(value = "HelpDeskData", description = "This controller contain all  operation of Field Agent")
...
public class FieldAgentController {
	...
	@RequestMapping(value = "/getfieldagentByGroupId", method = RequestMethod.GET)
	@ApiOperation(value = "This api is used to getfieldagentByGroupId based on id", notes = "Returns HTTP 200 if successful get the record")
	public ResponseEntity<Object> getEmailRequestById(@RequestParam("groupid") Long groupid) throws Exception {
		GenericResponse objGenericResponse = fieldAgentService.getfieldagentByGroupId(groupid);
