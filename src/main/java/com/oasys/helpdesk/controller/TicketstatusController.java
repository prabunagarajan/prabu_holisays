...
public class TicketstatusController {
	...
	public ResponseEntity<Object> adddticketPage(@Valid @RequestBody TicketstausRequestDTO requestDTO)
			throws RecordNotFoundException, Exception {

		return new ResponseEntity<>(ticketstatusservice.adddticket(requestDTO),
	...
	public ResponseEntity<Object> getAll() {
		return new ResponseEntity<>(ticketstatusservice.getAll(), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getById(@PathVariable("id") Long id) {
		return new ResponseEntity<>(ticketstatusservice.getById(id), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> updateDepartment(@Valid @RequestBody TicketstausRequestDTO requestDTO)
			throws RecordNotFoundException, Exception {
		return new ResponseEntity<>(ticketstatusservice.updateticket(requestDTO),
				ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> searchByFilter(@Valid @RequestBody PaginationRequestDTO paginationRequestDTO)  {
		return new ResponseEntity<>(ticketstatusservice.searchByFilter(paginationRequestDTO), ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getAllActive() {
		return new ResponseEntity<>(ticketstatusservice.getAllActive(), ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getCode() throws JsonParseException, ParseException {
		return new ResponseEntity<>(ticketstatusservice.getCode(), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
