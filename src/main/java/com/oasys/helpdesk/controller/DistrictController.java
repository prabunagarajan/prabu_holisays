...
import com.oasys.helpdesk.service.DistrictService;
...
public class DistrictController {
	...
	public ResponseEntity<Object> adddticketPage(@Valid @RequestBody DistrictRequestDTO requestDTO)
			throws RecordNotFoundException, Exception {

		return new ResponseEntity<>(districtservice.adddistrict(requestDTO),
	...
	public ResponseEntity<Object> getAll() {
		return new ResponseEntity<>(districtservice.getAll(), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getById(@PathVariable("id") Long id) {
		return new ResponseEntity<>(districtservice.getById(id), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> updateDepartment(@Valid @RequestBody DistrictRequestDTO requestDTO)
			throws RecordNotFoundException, Exception {
		return new ResponseEntity<>(districtservice.updatedistrict(requestDTO),
				ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> searchByFilter(@Valid @RequestBody PaginationRequestDTO paginationRequestDTO)  {
		return new ResponseEntity<>(districtservice.searchByFilter(paginationRequestDTO), ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	
	
	@GetMapping("/allactive")
	@ApiOperation(value = "This api is to get all active status", notes = "Returns HTTP 200 if successful get the record")
	public ResponseEntity<Object> getAllActive() {
		return new ResponseEntity<>(districtservice.getAllActive(), ResponseHeaderUtility.HttpHeadersConfig(), HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> getCode() throws JsonParseException, ParseException {
		return new ResponseEntity<>(districtservice.getCode(), ResponseHeaderUtility.HttpHeadersConfig(),
				HttpStatus.OK);
	}
